...
import img3 from "../../images/banner-15.jpg"
...
<Box sx={{display:"flex", mt:2.5,alignItems:"center",gap:2}}>
<Swiper
          loop={true}
          pagination={{
            dynamicBullets: true,
              ...
              <SwiperSlide key={item.link} className="parent-slider">
                ...
                >
                  ...
                  <Stack
                    ...
                    alignItems={"center"}
                  >
                    <Typography className='font-1' color={"#333"} mr={1} variant="h4">
                      SALE UP TO
                    </Typography>
        ...
        <Box sx={{display:{xs:"none",md:"block",minWidth:"20%"}}}> 
